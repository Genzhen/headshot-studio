...
import { CreditCard, Palette, UploadCloud } from "lucide-react";
...
export default function StepProgress({ currentStep, steps = defaultSteps }: StepProgressProps) {
  return (
    <div className="relative mx-auto mb-[var(--spacing-stack-lg)] flex max-w-2xl items-center justify-between">
      <div className="absolute left-0 top-1/2 h-0.5 w-full -translate-y-1/2 bg-surface-container-highest" />
      <div
        className="absolute left-0 top-1/2 h-0.5 -translate-y-1/2 bg-secondary-container transition-all duration-500"
