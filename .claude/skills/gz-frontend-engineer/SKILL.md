...
description: 前端工程师 Skill，执行前端开发任务，适配 Next.js 15 App Router + React 19 + Tailwind CSS 4 + tRPC Client + Turborepo 技术栈，支持 Stitch 设计稿还原
---

# gz-frontend-engineer — 前端工程师

执行前端开发任务。遵循 Headshot Studio 的 Next.js 15 + React 19 + Tailwind CSS v4 架构规范。
...
- **设计稿路径**: `/Users/gz/Desktop/Advance/Task/week_two/stitch_ai_headshot_studio`
...
- **API 客户端**: tRPC Client (在 `apps/web/src/lib/trpc.ts` 或类似位置)
